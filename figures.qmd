...
```{r}
expected_kmers <- function(nreads, gsize, k, read_size = 100, eseq = 3.5e-3) {
  nkmer <- (read_size - k + 1) * nreads
  depth <- nkmer / (gsize - k + 1)
  (gsize - k + 1) * (1 - exp(-depth)) + (eseq * k * nkmer)
}
...
![](http://127.0.0.1:47755/chunk_output/37087A8226dca95b/80E4C04F/ck4xec3z5vp9s/00003c.png?resize=23)
